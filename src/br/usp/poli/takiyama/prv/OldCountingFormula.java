 ...
 *
 */
public class OldCountingFormula extends ParameterizedRandomVariable {
	 ...
	 */
	public static OldCountingFormula getInstance(
			LogicalVariable boundVariable, 
			Set<Constraint> constraints, 
			ParameterizedRandomVariable prv) {
		return new OldCountingFormula(boundVariable, constraints, prv);
	}
	...
	public ParameterizedRandomVariable applyOneSubstitution(Binding s) {
		...
		/*
		 * This is wrong! What if the binding is not A/t?
		 */
		return new OldCountingFormula((StdLogicalVariable) s.secondTerm(), 
	 ...
	 */
	public OldCountingFormula addConstraint(Constraint constraint) {
		HashSet<Constraint> constraints = 
				new HashSet<Constraint>(this.constraints);
		constraints.add(constraint);
		return new OldCountingFormula(this.boundLogicalVariable, 
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof OldCountingFormula))
	    	return false;
		OldCountingFormula targetObject = (OldCountingFormula) other;
